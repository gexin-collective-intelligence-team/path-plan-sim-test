...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow, grid_widget):
        ...
        self.combo_arithmetic.setGeometry(QtCore.QRect(310, 450, 100, 25))
        ...
        self.label_map.setGeometry(QtCore.QRect(40, 475, 54, 21))
